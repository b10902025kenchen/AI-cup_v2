"""
此檔會填入testing data的null value，如果是類別型，我們把null視為新的類別；如果是數值型，我們填入平均值
讀入一個檔案test_time_myf_cano_moref_conam.csv，輸出新的檔案test_time_myf_cano_moref_conam_null.csv
"""

import pandas as pd

# Read the CSV file into a DataFrame
file_path = "test_time_myf_cano_moref_conam.csv"  # Replace with the actual file path
...
output_file_path = "test_time_myf_cano_moref_conam_null.csv"
